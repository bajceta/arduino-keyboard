...
uint8_t momentary[] = {
    ...
    NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, KEY_ESC,
    NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, NOC, KEY_TAB, NOC, NOC, NOC, NOC
};
uint8_t matrix[][56] = {
    {// L0
        ...
        KEY_LEFT_CTRL, L3, L4, KEY_LEFT_ALT, KEY_LEFT_GUI, ' ', L1, L2, ' ', KEY_RIGHT_ALT, KEY_LEFT_ARROW, KEY_DOWN_ARROW, KEY_UP_ARROW, KEY_RIGHT_ARROW
    }, {// L1
...
void handleSinglePress(char pos){
    if (pos==lastPosPress&&layer==0&&single){
